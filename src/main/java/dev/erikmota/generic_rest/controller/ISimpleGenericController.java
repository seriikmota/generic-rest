...
public interface ISimpleGenericController<DTO, TYPE_PK> {
    ...
    ResponseEntity<DTO> update(@PathVariable TYPE_PK id, @RequestBody DTO dto) throws JsonMappingException;
    ...
    ResponseEntity<List<DTO>> listAll();
